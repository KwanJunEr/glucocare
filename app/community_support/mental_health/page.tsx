    ...
    <div>
      ...
      <Card title="Log your emotions" bordered={false}>
        ...
        <div className="mt-6">
          ...
          <TextArea rows={6} className="!mt-4" placeholder="Write about your day and emotions..."></TextArea>
          <Button className="mt-6" type="primary">Save Entry</Button>
        </div>
      </Card>
      <Card title="Emotion Trends" bordered={false} className="!mt-6">
        <Line {...config} />
      </Card>
      <Card title="Recent Entries" bordered={false} className="!mt-6" extra={<DatePicker onChange={onChange} needConfirm />}>
        <p>Not Happy today</p>
      </Card>
    </div>
  )
